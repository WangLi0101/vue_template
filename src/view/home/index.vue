  ...
  <div class="flex h-screen bg-gray-50">
    ...
    <div class="w-1/3 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="p-4 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-500">当前用户: {{ socketStore.name }}{{ socketStore.userId }}</p>
      </div>
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        >
          <div class="flex items-center space-x-3">
            <div class="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
              <span class="text-sm font-medium text-gray-600">{{ user.userName?.charAt(0).toUpperCase() }}</span>
            </div>
            <div>
        ...
        <div v-if="socketStore.users.length === 0" class="p-4 text-center text-gray-500">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <div class="p-4 bg-white border-b border-gray-200">
        <div v-if="selectedUser" class="flex items-center space-x-3">
          <div class="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center">
            <span class="text-sm font-medium text-gray-600">{{ selectedUser.userName.charAt(0).toUpperCase() }}</span>
          </div>
          <div>
            <h3 class="font-semibold text-gray-900">{{ selectedUser.userName }}</h3>
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-4" ref="messagesContainer">
        <div v-if="!selectedUser" class="flex items-center justify-center h-full">
        ...
        <div v-else>
          <div 
            ...
            :class="[
              'flex',
              message.senderId === socketStore.userId ? 'justify-end' : 'justify-start'
            ]"
          >
            <div 
              :class="[
