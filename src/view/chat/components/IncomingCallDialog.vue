...
.dialog {
  :deep(.incoming-call-dialog) {
    ...
    /* 更强的背景色（淡紫青色调叠加浅色底），强制覆盖默认背景 */
    background:
      linear-gradient(160deg, rgba(99, 102, 241, 0.1), rgba(14, 165, 233, 0.1)),
      linear-gradient(
        160deg,
  ...
  :deep(.el-dialog.incoming-call-dialog) .el-dialog__header,
  ...
  :deep(.el-dialog.incoming-call-dialog) .el-dialog__body,
